  ...
  return (
    <>
      <div
        ...
        className="trendingProductCard bgLight2 shadow rounded-4 trendingProductCard fullWidthWrapper productCard h-100"
      >
        <div className="row h-100">
          <div className="col-4 pe-sm-4 productImg overflow-hidden">
          ...
          <div className="p-4 col-8 undefined ps-sm-5 productDetails">
            <h4 className="fs-16 fs-18 fw-normal text-capitalize themeColorDark mb-3">
